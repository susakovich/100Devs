...
if (runnerAge > 18 && runnerRegistered === true) {
  raceNumber += 1000;
  console.log(
    `You will race at 9:30am, and your race number is ${raceNumber}.`
  );
} else if (runnerAge > 18 && runnerRegistered === false) {
  console.log(
    `You will race at 11:00am, and your race number is ${raceNumber}.`
  );
} else if (runnerAge < 18) {
  console.log(
    `You will race at 12:30pm, and your race number is ${raceNumber}.`
  );
} else {
  console.log(
    `Since you are exactly 18 years old, please see the registration desk.`
  );
}
