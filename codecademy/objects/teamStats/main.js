...
const team = {
  _players: [
    { firstName: "Danijel", lastName: "Susakovic", age: 32 },
    { firstName: "Azra", lastName: "Susakovic", age: 28 },
    { firstName: "Dalija", lastName: "Susakovic", age: 1.5 },
  ],
  _games: [
    { opponent: "Bulls", teamPoints: 92, opponentPoints: 91 },
    { opponent: "Raptors", teamPoints: 79, opponentPoints: 81 },
    { opponent: "Grizzlies", teamPoints: 112, opponentPoints: 101 },
  ],
